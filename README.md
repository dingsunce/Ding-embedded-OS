Ding embeded os is a tiny operating system that runs on tiny microcontrollers including 8bits mcu,
It has basic os function, process management, memory management, timer, task, message management......
The rom footprint is 2k, ram footprint can be customized to 3k 
The code belowing is the example that is a introduction how to use it:
...
do not use any os api in interrupt except void Process_Poll(Process_t *p); OS components do not have any preemptive protection
...
void main(void)
{
  ...
  // call SysTick_Handler in interruption every 200us
  while (1)
  {
