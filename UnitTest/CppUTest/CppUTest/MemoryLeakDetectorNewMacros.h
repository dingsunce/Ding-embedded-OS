...
/*
 * This file can be used to get extra debugging information about memory leaks in your production
 * code. It defines a preprocessor macro for operator new. This will pass additional information to
 * the operator new and this will give the line/file information of the memory leaks in your code.
 *
 ...
 *    This can be done by creating your own NewMacros.h file that includes your operator new
 * overrides and THEN this file.
 *
 * STL (or StdC++ lib) also does overrides for operator new. Therefore, you'd need to include the
 * STL files *before* this file too.
 *
 */
...
/* This #ifndef prevents <new> from being included twice and enables the file to be included
 * anywhere */
