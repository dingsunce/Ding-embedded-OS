...
#define UINT_BYTES(nUint) FOURTH_BYTE(nUint), THIRD_BYTE(nUint), SECOND_BYTE(nUint), FIRST_BYTE(nUint)
...
#define BUILD_U32(byte3, byte2, byte1, byte0)                                                                \
  ((u32)(((u32)((byte3) & 0xFF) << 24) + ((u32)((byte2) & 0xFF) << 16) + ((u32)((byte1) & 0xFF) << 8) +      \
         ((u32)((byte0) & 0xFF))))
#endif

#ifndef BUILD_U16
#define BUILD_U16(highByte, lowByte) ((u16)((u16)((u16)((highByte) & 0xFF) << 8) + (u16)((lowByte) & 0xFF)))
#endif
#ifndef HIGH_U16
